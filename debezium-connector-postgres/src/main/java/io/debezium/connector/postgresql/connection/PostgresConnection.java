...
public class PostgresConnection extends JdbcConnection {
                    ...
                    rs -> {
                        if (rs.next()) {
                            ...
                            if (confirmedFlushedLSN == null) {
                                System.out.println("confirmedFlushedLSN is null");
                                return null;
                            }
    ...
    private Long parseConfirmedFlushLsn(String slotName, String pluginName, String database, ResultSet rs) {
        ...
        try {
//            String confirmedFlushLSNString = rs.getString("confirmed_flush_lsn");     //我注掉的源码
            String confirmedFlushLSNString = rs.getString("restart_lsn");   //做的修改
    ...
    //删除老的replication
    public void deleteOldReplication() throws SQLException{
        execute("select pg_drop_replication_slot('debezium')");
    }
